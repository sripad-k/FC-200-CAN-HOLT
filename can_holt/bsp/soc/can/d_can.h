...
/* Program CAN Filtering on a single ID */
d_Status_t d_CAN_ProgramSingleIDFilter(const Uint32_t channel, const d_CAN_Message_t *const pMessage);

/* Program CAN Filtering on a CAN Range ID */
d_Status_t d_CAN_ProgramRangeIDFilter(const Uint32_t channel, const d_CAN_Message_t *const pCanIdStart, const d_CAN_Message_t *const pCanIdEnd);
