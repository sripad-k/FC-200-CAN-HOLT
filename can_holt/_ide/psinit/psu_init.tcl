...
set psu_clock_init_data {
    ...
    mask_write 0XFF180308 0x000198C3 0x000198C3
    ...
    mask_write 0XFF5E00C0 0x013F3F07 0x01011100
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD0700E8 0xFFFFFFFF 0x000016C0
    ...
    mask_write 0XFD070100 0x7F3F7F3F 0x0F082412
    ...
    mask_write 0XFD0701C0 0x00000007 0x00000005
    ...
    mask_write 0XFD080114 0xFFFFFFFF 0x28100008
    ...
    mask_write 0XFD080194 0xFFFFFFFF 0x000016C0
...
set psu_mio_init_data {
    ...
    mask_write 0XFF18006C 0x000000FE 0x00000080
    ...
    mask_write 0XFF180070 0x000000FE 0x00000080
    ...
    mask_write 0XFF1800A8 0x000000FE 0x00000020
    ...
    mask_write 0XFF1800AC 0x000000FE 0x00000020
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00000600
    ...
    mask_write 0XFF18013C 0x03FFFFFF 0x00000400
    ...
    mask_write 0XFF180158 0x03FFFFFF 0x00018000
    ...
    mask_write 0XFF180164 0x03FFFFFF 0x01E7BFFF
    ...
    mask_write 0XFF180160 0x03FFF79E 0x03FFF38E
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD402368 0x000000FF 0x000000E0
    ...
    mask_write 0XFD402370 0x000000FF 0x000000C9
    ...
    mask_write 0XFD402374 0x000000FF 0x000000D2
    ...
    mask_write 0XFD401900 0x000000FF 0x0000007D
    ...
    mask_write 0XFD410010 0x00000077 0x00000052
...
set DQ8RBD_0 [expr {(0x0000003F & [mrd -force -value 0xFD080F50]) >> 0x00000000 }]
set DQ8RBD_1 [expr {(0x00003F00 & [mrd -force -value 0xFD080F50]) >> 0x00000008 }]
set DQ8RBD_2 [expr {(0x003F0000 & [mrd -force -value 0xFD080F50]) >> 0x00000010 }]
set DQ8RBD_3 [expr {(0x3F000000 & [mrd -force -value 0xFD080F50]) >> 0x00000018 }]
set DQ8RBD_4 [expr {(0x0000003F & [mrd -force -value 0xFD080F54]) >> 0x00000000 }]
set DQ8RBD_5 [expr {(0x00003F00 & [mrd -force -value 0xFD080F54]) >> 0x00000008 }]
set DQ8RBD_6 [expr {(0x003F0000 & [mrd -force -value 0xFD080F54]) >> 0x00000010 }]
set DQ8RBD_7 [expr {(0x3F000000 & [mrd -force -value 0xFD080F54]) >> 0x00000018 }]
...
set cal_byte8 [expr {($DQ8RBD_0 + $DQ8RBD_1 + $DQ8RBD_2 + $DQ8RBD_3 + $DQ8RBD_4 + $DQ8RBD_5 + $DQ8RBD_6 + $DQ8RBD_7)/8}]
...
psu_mask_write 0xFD080F58 0x0000003F $cal_byte8
